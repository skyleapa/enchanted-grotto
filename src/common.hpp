...
enum class TEXTBOX {
	ENTER_FOREST = 0,
	ENTER_DESERT = ENTER_FOREST + 1,
	ENTER_MUSHROOM = ENTER_DESERT + 1,
	ENTER_CRYSTAL = ENTER_MUSHROOM + 1,
	ENTER_FOREST_EX = ENTER_CRYSTAL + 1,
	ENTER_GROTTO = ENTER_FOREST_EX + 1,
	EXIT_GROTTO = ENTER_GROTTO + 1,
	CAULDRON = EXIT_GROTTO + 1,
	COFFEE_BEAN = CAULDRON + 1,
	SAP = COFFEE_BEAN + 1,
	TWIG = SAP + 1,
	MAGICAL_FRUIT = TWIG + 1,
	MAGICAL_DUST = MAGICAL_FRUIT + 1
};

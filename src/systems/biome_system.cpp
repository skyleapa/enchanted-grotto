...
void BiomeSystem::createDesert()
{
    ...
    createDesertExit(renderer, vec2(GRID_CELL_WIDTH_PX * 20.3, GRID_CELL_HEIGHT_PX * 12.9), 8, "Grotto Entrance");
    ...
    createDesertSkull(renderer, vec2(GRID_CELL_WIDTH_PX * 13.5, GRID_CELL_HEIGHT_PX * 10.8));
}
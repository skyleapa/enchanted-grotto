...
bool SoundSystem::startAndLoadSounds()
{
    ...
    return !(!boil_sound || !bottle_high_quality_potion_sound || !bottle_sound || !collect_item_sound || !drop_in_cauldron_sound || !enemy_ouch_sound || !interact_menu_sound || !page_flip_sound || !stir_sound || !throw_sound || !turn_dial_sound);
}
